...
.directive('myTabs', function() {
	return {
		...
		templateUrl: 'js/components/template/my-tabs.html'
	};
})
...
.directive('myTab', function() {
	return {
		...
		templateUrl: 'js/components/template/my-tab.html'
	};
})
...
.directive('showHideContainer', function(){
	return {
		...
		templateUrl: 'js/components/template/show-hide-password.html',
		restrict: 'A',
		replace: false,
		transclude: true
	};
...
.directive('ionicYoutubeVideo', function($timeout, $ionicPlatform, youtubeEmbedUtils) {
	return {
		...
		templateUrl: 'js/components/template/ionic-youtube-video.html',
		replace: false
	};
})
...
.directive('multiBg', function(_){
	return {
		...
		templateUrl: 'js/components/template/multi-bg.html',
		restrict: 'A',
		replace: true,
		transclude: true
	};
...
.directive('preImg', function() {
	return {
		...
		templateUrl: 'js/components/template/pre-img.html'
	};
})
